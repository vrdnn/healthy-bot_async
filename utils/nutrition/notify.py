...
from keyboards.inline.nutrition import meal_keyboard
from loader import tz, bot
from utils.db_api.database import UserToNotifyAboutNutritionMeal, NutritionMeal
...
async def notify_users(time_between_notification_updates: int = TIME_BETWEEN_NOTIFICATION_UPDATES):
    while True:
        ...
        for meal in nutrition_meals:
            ...
            keyboard = meal_keyboard(meal=meal, prev_meal_id=prev_meal_id, next_meal_id=next_meal_id)
